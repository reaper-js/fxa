...
try {
  ...
  firefox.addEventListener('profile:change', (event) => {
  ...
  firefox.addEventListener('fxaccounts:change_password', (event) => {
    if (isForCurrentUser(event)) {
  ...
  firefox.addEventListener('fxaccounts:delete', (event) => {
    if (isForCurrentUser(event)) {
      window.location.assign('/');
    }
  });
  firefox.addEventListener('fxError', (event) => {
    console.error(event);
  });
